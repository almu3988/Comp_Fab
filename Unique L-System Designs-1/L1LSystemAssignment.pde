...
// https://github.com/leahbuechley/Turtle mnmnmmnmnm
...
void setup() {
  ...
  lSys = initSquare();
  lSys2 = initMirrorDragonCurve();  // Mirrored Dragon Curve
...
void draw() {
  print("Drawing L-System with " + numIterations + " iterations...");
  background(255);  
  ...
  t.penDown();
  println("Current L-System: " + lSys.getIterationString());
